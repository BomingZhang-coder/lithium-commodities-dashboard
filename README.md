...
4. Emma, Rishabh: Digested Birdy's previous work on [folder](task_2-birdy) Mining Company Regression. Updating the code for [time-series-regression](task_2-geert/task_2-birdy/3. Li2CO3-time-series-regression.ipynb) given the new company lists.
