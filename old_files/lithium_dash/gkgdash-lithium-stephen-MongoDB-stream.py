...
lithium_merged=lithium_merged[['dates','DocumentIdentifier','SourceCommonName']]
...
def server_start():
    ...
    layout=dbc.Container([
        ...
        html.Div([
            dcc.Graph(id='spyder_up', style={'display': 'inline-block','height':'650px','width':'2000px'}),
            dcc.Graph(id='spyder_down',style={'display': 'inline-block','height':'650px','width':'2000px'})]),
        html.Div([
            dcc.Graph(id='scatter_up', style={'display': 'inline-block','height':'1300px'}),
            dcc.Graph(id='scatter_down',style={'display': 'inline-block','height':'1300px'})]),
        html.Div([
            dcc.Graph(id='groupedscatter_up', style={'display': 'inline-block','height':'1000px'}),
            dcc.Graph(id='groupedscatter_down',style={'display': 'inline-block','height':'1000px'})]),
        html.Div([
            dcc.Graph(id='freqhist_up', style={'display': 'inline-block'}),
            dcc.Graph(id='freqhist_down',style={'display': 'inline-block'})]),
        html.Div([
            dcc.Graph(id='avghist_up', style={'display': 'inline-block'}),
            dcc.Graph(id='avghist_down',style={'display': 'inline-block'})]),
        html.Div([
            dcc.Graph(id='heatmap_up', style={'display': 'inline-block'}),
            dcc.Graph(id='heatmap_down',style={'display': 'inline-block'})]),
        html.Div([
            html.Div(id='table_up', style={'display': 'inline-block'}),
            html.Div(id='table_down',style={'display': 'inline-block'})]),
        html.Div([
            html.Div(id='tableurl_up', style={'display': 'inline-block'}),
            html.Div(id='tableurl_down',style={'display': 'inline-block'})]),
        html.Div([
            dcc.Graph(id='themegraph_up', style={'display': 'inline-block'}),
            dcc.Graph(id='themegraph_down',style={'display': 'inline-block'})]),
        html.Div([
            dcc.Graph(id='stackedbar_relative_up', style={'display': 'inline-block'}),
            dcc.Graph(id='stackedbar_relative_down',style={'display': 'inline-block'})]),

        html.Div(
            style = {'display' : 'flex'},
            children=[
                html.Div(
                        dcc.Graph(id='barsource_up')),
                html.Div(
                        dcc.Graph(id='barsource_down'))
            ]),
...
server = app.server
app.layout=server_start

@app.callback(Output('spyder_up', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_spyder_up(value,start_date,end_date):
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(up_key))]
...
@app.callback(Output('spyder_down', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_spyder_down(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(down_key))]
...
@app.callback(Output('scatter_up', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_scatter_up(value,start_date,end_date):
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(up_key))]
...
@app.callback(Output('scatter_down', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_scatter_down(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(down_key))]
...
@app.callback(Output('groupedscatter_up', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
...
@app.callback(Output('groupedscatter_down', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_spyder24(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(down_key))]
...
@app.callback(Output('freqhist_up', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_freqhist_up(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(up_key))]
...
@app.callback(Output('freqhist_down', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_freqhist_down(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(down_key))]
...
@app.callback(Output('avghist_up', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_avghist_up(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(up_key))]
...
@app.callback(Output('avghist_down', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_avghist_down(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(down_key))]
...
@app.callback(Output('heatmap_up', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_heatmap_up(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(up_key))]
...
@app.callback(Output('heatmap_down', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_heatmap_down(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(down_key))]
...
@app.callback(Output('table_up', 'children'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_table_up(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(up_key))]
...
@app.callback(Output('table_down', 'children'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_table_down(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(down_key))]
...
@app.callback(Output('tableurl_up', 'children'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_tableurl_up(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(up_key))]
...
@app.callback(Output('tableurl_down', 'children'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_tableurl_down(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(down_key))]
...
@app.callback(Output('themegraph_up', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_themegraph_up(value,start_date,end_date):
    #org = newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(up_key))]
...
@app.callback(Output('themegraph_down', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_themegraph_down(value,start_date,end_date):
    #org = newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(down_key))]
...
@app.callback(Output('stackedbar_up', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_stackedbar_up(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(up_key))]
...
@app.callback(Output('stackedbar_down', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_stackedbar_down(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(down_key))]
...
@app.callback(Output('stackedbar_relative_up', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_stackedbar_relative_up(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(up_key))]
...
@app.callback(Output('stackedbar_relative_down', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_stackedbar_relative_down(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=newdata24[newdata24['DocumentIdentifier'].str.contains('|'.join(down_key))]
...
#     wc = mpld3.fig_to_html(fig)
#     return wc
@app.callback(Output('barsource_up', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_barsource(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=lithium_merged[lithium_merged['DocumentIdentifier'].str.contains('|'.join(up_key))]
...
@app.callback(Output('barsource_down', 'figure'),
              Input('dropdown24', 'value'),Input('datepicker1', 'start_date'),Input('datepicker1', 'end_date'))
def update_barsource(value,start_date,end_date):
    #org=newdata24[newdata24['Organizations'].str.contains(input_value)]
    org=lithium_merged[lithium_merged['DocumentIdentifier'].str.contains('|'.join(down_key))]
