...
spot_prices_df.columns = ["nickel", "iron", "aluminium", "cobalt", "lithium", "manganese", "phosphorous"]
...
plt.title("Conglomerated Scaled Cost of Battery Cathode in Standard EV")
#plt.show()
